    ...
    <div className="min-h-screen bg-mist print:bg-white">
      ...
      <article className="print-page mx-auto my-6 max-w-4xl rounded-xl bg-white p-8 shadow-card print:my-0">
        <header className="border-b-4 border-petrol pb-4">
          <p className="font-display text-xs font-semibold uppercase tracking-widest text-petrol">Care Quality Intelligence · Inspection-ready evidence</p>
          ...
          <p className="mt-1 text-sm text-ink/70">
            ...
            prepared from the Care Quality Intelligence system
          </p>
        </header>
        ...
        <footer className="mt-8 border-t border-ink/15 pt-3 text-[10px] text-ink/50">
          Generated by Care Quality Intelligence · People we support are identified by reference code only ·
